...
CREATE POLICY "Access for auth users" ON ingredients FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON recipes FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON recipe_items FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON recipe_steps FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON dietary_tags FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON ingredient_tags FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON recipe_tags FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON menus FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON menu_items FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON shopping_lists FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON shopping_list_items FOR ALL USING (auth.role() = 'authenticated');
...
CREATE TABLE ingredient_suppliers (
    ...
    unit_size NUMERIC(10, 4) DEFAULT 1, -- Standard package size (e.g., 5 kg bag)
    unit_type TEXT, -- If different from ingredient unit
...
CREATE POLICY "Access for auth users" ON suppliers FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Access for auth users" ON ingredient_suppliers FOR ALL USING (auth.role() = 'authenticated');
